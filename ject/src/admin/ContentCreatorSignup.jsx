...
const ContentCreatorSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = registerUser(formData.email.trim(), formData.password.trim(), formData.name.trim(), 'content-creator');
      ...
      <fieldset style={{
        ...
        <form onSubmit={handleSubmit}>
          <p style={{ 
            ...
            Join us to create amazing heritage content!
          </p>
          ...
          <p style={{ marginTop: '1.5rem', fontSize: '1rem' }}>
            ...
            <button
              type="button"
              onClick={() => navigate('/admin/content-creator-login')}
              style={{ 
                color: '#DAA520', 
                fontWeight: 'bold', 
